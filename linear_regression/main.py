...
# X axis named x
# It has data of the type, dense_vector(13); denoting to 13 different attributes
# that account for the prices of those houses
...
# The y axix, takes input the x-attributes, and initiates Linear Regression on them

y = paddle.layer.data(name='y', type=paddle.data_type.dense_vector(1))

cost = paddle.layer.mse_cost(input=y_predict, label=y)
# Cost - measure_cost(input is y_predict, label is y i.e where it's reflected)

parameters = paddle.parameters.create(cost)

optimizer = paddle.optimizer.Momentum(momentum=0)
# why do we use this and what's momentum
